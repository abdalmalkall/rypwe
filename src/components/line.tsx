              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 bg-gray-800 rounded-lg border border-gray-700 flex items-center justify-center transition-all duration-300 hover:scale-105 hover:bg-gray-700"
                  >
                    {social.icon}
                  </a>
                ))}
